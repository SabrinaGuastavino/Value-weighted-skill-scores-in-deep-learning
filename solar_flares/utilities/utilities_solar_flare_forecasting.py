...
def read_data_construct_sets(folder_data, class_flare):
    ...
    return X_train_std,Y_train_new, X_val_std, Y_val, df_train, panel_23features_val_from_2015_09_29_to_2015_11_01, X_test_std, Y_test,panel_test_2017_until_harp5634
...
def select_best_patience_on_val(folder_path,class_flare,X_train_std,Y_train_new, df_train, X_val_std, Y_val,panel_23features_val_from_2015_09_29_to_2015_11_01):
    ...
    for i in range(1,6):
        ...
        if class_flare == 'abovec' or class_flare == 'abovem':
            ...
            model.load_weights(folder_path+'early_stop'+str(patience)+'_nn7593param_'+class_flare+'_00_std_reg2layers_train_from_2012_09_15_to_2014_10_09_val_from_2014_10_10_to_2015_06_14.hdf5')
        ...
        [threshold_weight,max_tss_weight] = optimize_time_weighted_tss_solar_flares(pred_prob_train_early,Y_train_new,df_train)#panel_train
...
def predict(folder_path,idx_patience_tss,class_flare,X_test_std,threshold_opt_tss):
    model = Sequential()
    ...
    if class_flare == 'abovec' or class_flare == 'abovem':
        model.load_weights(folder_path+'early_stop'+str(int((idx_patience_tss+1)*10))+'_nn7593param_'+class_flare+'_00_std_reg2layers_train_from_2012_09_15_to_2015_10_02_val_from_2015_09_29_to_2015_11_01.hdf5')
    elif class_flare == 'abovex':
        model.load_weights(folder_path+'early_stop'+str(int((idx_patience_tss+1)*10))+'_nn7593param_'+class_flare+'_00_std_reg2layers_train_from_2012_09_15_to_2014_10_09_val_from_2014_10_10_to_2015_06_14.hdf5')

    
    pred_prob_test = model.predict(X_test_std)
